...
public class TrialInfoData : MonoBehaviour {
    ...
    public bool WriteData(string peripheralDirection, int nCoherent, int nTargets, int response, List<float> targetTime)
    {
        ...
        string targDirection = expCueRef.activeTarget.name;                 // get movement direction from name of the gameobject
        targDirection = targDirection.Remove(targDirection.Length - 13);    // remove "Motion_Sphere" at end of gameobject name
