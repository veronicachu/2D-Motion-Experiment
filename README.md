...
### Experiment Build:
To see program, download from [here](https://drive.google.com/file/d/1oBFmVlUJXW6VR4W1csCfLkVDCUfaZy-r/view?usp=sharing) or go into 'Basic Motion SSVEP' folder and run 'Basic Motion SSVEP.exe'.
